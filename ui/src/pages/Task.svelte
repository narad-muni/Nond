    ...
    <main class="flex flex-col w-full min-w-0 max-h-full p-2">
        <div class="pl-4 flex gap-x-4 my-2">
            ...
            <Button gradient color="green" id="status" on:click={changeFilter}>
                <svg xmlns="http://www.w3.org/2000/svg" id="status" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <Button gradient color="green" id="bill" on:click={changeFilter}>
                <svg xmlns="http://www.w3.org/2000/svg" id="bill" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
