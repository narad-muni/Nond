<script>
    ...
    async function openActionsModal(e){
        ...
        actionsObject = await utils.get('/api/task_template/'+data[actionsIndex].id);
    ...
    async function updateData(){
        const resp = await utils.put_json('/api/task_template/',actionsObject);
    ...
    async function deleteSelected(){
        const resp = await utils._delete('/api/task_template/destroy/',{id:Array.from(selectedRows)});
    ...
    async function createData(){
        let resp = await utils.post_json('/api/task_template/',createdObject);
